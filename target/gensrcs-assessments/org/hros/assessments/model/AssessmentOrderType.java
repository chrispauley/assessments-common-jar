 ...
 *       &lt;sequence&gt;
 *         &lt;group ref="{}DocumentIDGroup" minOccurs="0"/&gt;
...
public class AssessmentOrderType {
    ...
    protected List<Object> alternateDocumentID;
    ...
    @XmlElement(name = "AssessmentAccess")
     ...
     * 
     */
    public List<Object> getAlternateDocumentID() {
        if (alternateDocumentID == null) {
            alternateDocumentID = new ArrayList<Object>();
        }

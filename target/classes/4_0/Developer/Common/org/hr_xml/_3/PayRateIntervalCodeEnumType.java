 ...
 * 
 */
@XmlType(name = "PayRateIntervalCodeEnumType", namespace = "http://www.hr-xml.org/3")
@XmlEnum
public enum PayRateIntervalCodeEnumType {
    ...
    /**
     * A flat amount paid once without regard to one of the above intervals. Could be paid once per assignment or review period or other applicable conceptual period.
     * 
     */
    @XmlEnumValue("Once")
    ONCE("Once");
